...
export const LABS: LabTheme[] = [
  ...
  },
  {
    ...
    color: "#1e2a5a",
    accent: "#4f46e5",
    soft: "rgba(30, 42, 90, 0.1)",
    badge: "P",
  },
];

export const WEEK_DAYS = [
  { id: "sat", fa: "شنبه", en: "SAT", short: "ش" },
  { id: "sun", fa: "یکشنبه", en: "SUN", short: "ی" },
  { id: "mon", fa: "دوشنبه", en: "MON", short: "د" },
  { id: "tue", fa: "سه‌شنبه", en: "TUE", short: "س" },
  { id: "wed", fa: "چهارشنبه", en: "WED", short: "چ" },
  { id: "thu", fa: "پنج‌شنبه", en: "THU", short: "پ" },
  { id: "fri", fa: "جمعه", en: "FRI", short: "ج" },
] as const;
